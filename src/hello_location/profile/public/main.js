...
profile.__getAsset("index.html")
  ...
  //results URL, submit should not take you here from the loan origination screen
  //analyze last year's deliveries and determine the interest rate that will be presented,
  //in the URL, you should have the year, the deliveries made
  ...
  $('#edit-form').submit(function (event) {
    ...
    //storing values of the UI to the loan
    ...
    async function action() {
      ...
      //  After the input of loan data, this can be a dynamic loan summary, what year is it, what is my interest rate, 
      // what was yearly deliveries made for the most recent year-->
      renderOwnProfile();
